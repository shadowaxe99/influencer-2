        ...
        <div className="grid grid-cols-4 gap-6">
          {characters.map((character, index) => (
            <div className="flex flex-col items-center group card animate__animated animate__zoomIn hover-effect">
              <Image src={character.img} alt={character.name} height={100} width={100} className="rounded-full transform transition-all duration-300 ease-in-out" onMouseEnter={() => playGreetingSound(character.greeting_sound)} />
