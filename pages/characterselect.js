...
const CharacterSelect = () => {
    ...
    const israelSupportImagePaths = [
        "/israel-support/israel-1.png",
        "/israel-support/israel-2.png",
        "/israel-support/israel-4.png"
    ];
    ...
    const handleCharacterClick = (index) => {
        ...
        setThemeImagePaths(characters[index].themeImagePaths);
        router.push("/playground");
    };
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <div class="terminal-header" onMouseDown={handleMouseDown}>
                        Command Prompt
                    </div>
                ...
                <div className="preloader-content">
                    ...
                    <p className="preloader-subtitle">Entering the future...</p>
                ...
                <div className="video-container">
                    ...
                    <span>
                        Character selection should be based on your knowledge of
                        AI
                    </span>
                    <div
                    ...
                    >
                        {characters.map((character, index) => (
                            <div
                                ...
                                onMouseEnter={() =>
                                    handleMouseEnterCharacter(character.sound)
                                }
                            >
                                <Image
                                    src={character.img}
